...
We used caret and randomForest, this allowed me to generate correct answers for
each of the 20 test data cases provided in this assignment.  
a seed value is used for consistent results.
...
First, we loaded the data both from the provided training and test data provided by COURSERA.
...
We casted all columns 8 to the end to be numeric.
...
choosing a feature set amd remove user name, timestamps and windows.  
